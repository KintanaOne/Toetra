...
Each binder introduces one exact `PointSymbol` and one lexical frame. FORML preserves the source identifier through semantic validation, IR1, IR2, ModelBridge, backend symbols, reports, and replay.
