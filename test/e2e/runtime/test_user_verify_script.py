...
from demo.user_verify_script import main, run_verification
from dsl.backends.results import VerificationStatus


def test_user_script_runs_public_api_and_writes_json(tmp_path, capsys) -> None:
...
def test_user_script_demo_mode_runs_without_external_files(tmp_path, capsys) -> None:
