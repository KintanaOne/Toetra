...
| IR1-NNF | Implemented / stabilizing | De Morgan and NNF belong to this layer. |
...
|---|---|
| Should IR1 be named `IR1` or `IR1-NNF` in code? | The documentation now treats NNF as an IR1 invariant. |
