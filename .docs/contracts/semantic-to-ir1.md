...
> Implementation: IR1 translator exists, NNF/De Morgan belong to this layer  
...
IR1 is not a backend query. It is the first normalized logical representation after semantic validation.
...
- eliminating or preparing implications when required;
