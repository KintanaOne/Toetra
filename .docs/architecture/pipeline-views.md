...
| Logical Verification Pipeline | Normalize and prepare logical assertions. | Implemented until IR1-NNF, planned after |
...
| IR1-NNF | Logical form after negation normalization. | Implemented / stabilizing |
...
5. **IR1-NNF boundary**: negations are pushed to leaves and boolean structure is normalized for later transformation.
...
| IR1-NNF | Apply De Morgan and negation normalization. | Implemented / stabilizing |
...
IR1 is responsible for early logical normalization. It captures the validated property in a backend-independent structure and normalizes negation through De Morgan and NNF-style transformations.
