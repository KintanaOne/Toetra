...
| IR1-NNF | Represents normalized logic with De Morgan / NNF guarantees. | Implemented / stabilizing |
...
IR1 is the first logical representation after semantic validation.

Responsibilities:

- remove or normalize implication structure when needed;
