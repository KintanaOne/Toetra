...
| P0 | IR1 Layer | `docs/compiler/ir1-layer.md` | implemented / stabilizing | Explain IR1, logical normalization, De Morgan, NNF. | IR1 is the current logical target. | Developers. |
...
| P0 | IR1 NNF | `docs/ir/ir1-nnf.md` | implemented / stabilizing | Explain De Morgan and NNF responsibilities. | IR1 must have clear invariants. | Developers. |
