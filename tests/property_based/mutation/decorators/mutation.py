...
from tests.property_based.mutation.core.registry import GLOBAL_MUTATION_REGISTRY
from tests.property_based.mutation.metadata.descriptor import MutationDescriptor
