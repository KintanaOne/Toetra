...
def test_inline_anchor_direct_check_replays_real_model(tmp_path) -> None:
...
def test_referenced_anchor_check_at_keeps_lookup_provenance(tmp_path) -> None:
