...
from tests.support.ir_serialization import serialize_logical
from tests.support.paths import FIXTURES_ROOT, GOLDEN_ROOT

CASE_PATH = FIXTURES_ROOT / "end_to_end" / "affine_specification_constants.toetra"
EXPECTED_PATH = GOLDEN_ROOT / "end_to_end" / "affine_specification_constants.json"
