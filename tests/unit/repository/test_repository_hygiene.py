...
OBSOLETE_CODE_PATHS = {
    ...
    "test",
    "tests/unit/ir2",
    "tests/fixtures/point_binding_evaluation",
    "tests/unit/parsing",
    "tests/e2e/normalization/test_run_nnf.py",
    "tests/property_based/mutation/functions/semantic/relationnal.py",
    "tests/property_based/mutation/functions/structural/cooruotion.py",
}
