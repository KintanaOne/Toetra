...
from toetra._provenance.model import ReportProvenance
...
class VerificationReport:
    ...
    def to_text(self) -> str:
        ...
        from toetra._reporting.text import render_verification_report_text
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        from toetra._reporting.json import verification_report_to_dict
    ...
    def to_json(self, *, indent: int | None = 2) -> str:
        ...
        from toetra._reporting.json import verification_report_to_json
    ...
    def write_json(self, path: str | Path, *, indent: int | None = 2) -> Path:
        ...
        from toetra._reporting.json import write_verification_report_json
    ...
    def to_html(self) -> str:
        ...
        from toetra._reporting.html import render_verification_report_html
    ...
    def write_html(self, path: str | Path) -> Path:
        ...
        from toetra._reporting.html import write_verification_report_html
