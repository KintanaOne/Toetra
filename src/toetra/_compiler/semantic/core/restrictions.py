...
from toetra._compiler.ast.nodes.primitives import AttributeNode, BinaryArithmeticNode
...
from toetra._compiler.semantic.core.scalar_typing import ScalarTypeAnalyzer
