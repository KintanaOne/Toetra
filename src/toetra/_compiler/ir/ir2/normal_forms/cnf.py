...
from toetra._compiler.ir.ir2.dsl.nodes import ClauseIR2, CNFFormulaIR2, LiteralIR2
from toetra._compiler.ir.ir2.enums import Polarity
from toetra._compiler.ir.ir2.errors import (
    InvalidNormalFormError,
    NormalFormExplosionError,
)
