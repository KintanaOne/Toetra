...
from toetra._compiler.ir.ir2.model import (
    AffineExpressionIR2,
...
- toetra._compiler.ir.ir2.dsl.* contains DSL/formula/task-level nodes;
- toetra._compiler.ir.ir2.model.* contains backend-neutral model constraint nodes.

This module intentionally re-exports the historical public API so existing
imports such as ``from toetra._compiler.ir.ir2.nodes import VerificationTaskIR2`` remain
