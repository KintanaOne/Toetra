# src/toetra/_language/tools/generator.py
...
from toetra._language.tools.constants import build_header
from toetra._language.tools.formatter import format_lark_output
from toetra._language.tools.transforms import (
    protect_brackets,
    remove_ebnf_commas,
    unprotect_brackets,
...
from toetra._language.tools.registry import GRAMMAR_REGISTRY
...
def main():
    input_path = Path("src/toetra/_language/grammar/toetra_grammar.ebnf")
    output_path = Path("src/toetra/_language/grammar/toetra_grammar.lark")
