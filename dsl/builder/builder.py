...
from test.fixtures.properties_samples import VALID_AT_WITH_NEIGHBORHOOD, VALID_CHECK_AT_WITH_COMPLEX_ASSERTION, VALID_FORALL_WITH_DOMAIN, VALID_MINIMAL_AT, VALID_MINIMAL_CHECK_AT, VALID_PAIRWISE_WITH_ABSTRACTOR
